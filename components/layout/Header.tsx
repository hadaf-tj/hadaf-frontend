...
const Header: React.FC<HeaderProps> = ({ variant = "default" }) => {
  ...
  return (
    ...
    >
      <div className="w-full mx-auto px-4 sm:px-8 lg:px-12 xl:px-20 h-12 flex items-center relative transition-colors duration-300">
        {/* --- ЛОГОТИП --- */}
        <Link
          href="/"
          className="flex items-center gap-1 sm:gap-3 group shrink-0 z-30 mr-8 lg:mr-12"
