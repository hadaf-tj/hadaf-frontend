      ...
      <main className="flex-1 flex flex-col lg:flex-row items-center justify-center px-6 py-24 lg:gap-16 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Button
              asChild
              className="h-14 bg-[#1e3a8a] text-white hover:bg-[#2a4ec2] font-bold text-lg px-8 rounded-2xl shadow-xl shadow-blue-900/10"
            >
              <Link href="/">
            ...
            <Button
              asChild
              variant="outline"
              className="h-14 border-2 border-gray-100 text-gray-500 hover:text-[#1e3a8a] hover:border-[#1e3a8a] font-bold text-lg px-8 rounded-2xl bg-transparent"
            >
