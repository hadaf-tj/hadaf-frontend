                ...
                <div className="pt-2 sm:pt-4 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-2.5 sm:gap-3">
                      <CheckCircle2
                        className="text-[#ffca63] flex-shrink-0"
                        size={20}
                      />
                      <span className="font-bold text-[#1e3a8a] text-sm sm:text-base">
                        {item}
                      </span>
                    </div>
                  ))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
                {members.map((member, idx) => (
                  ...
                  >
                    ...
                    <h3 className="text-lg sm:text-xl font-black text-gray-900 mb-1 relative z-10">
                      {member.full_name}
                    </h3>
                    ...
                    <div className="mt-auto flex gap-2.5 relative z-10">
                      {member.linkedin && (
                        <a
                          ...
                          className="inline-flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 bg-gray-50 text-[#0a66c2] rounded-full shadow-sm hover:shadow-md hover:bg-[#0a66c2] hover:text-white transition-all duration-300"
                        >
                          <Linkedin size={18} />
                        </a>
                      )}
                      {member.telegram && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 bg-gray-50 text-[#229ED9] rounded-full shadow-sm hover:shadow-md hover:bg-[#229ED9] hover:text-white transition-all duration-300"
                        >
                ...
                <Link
                  href="/vacancies"
                  className="bg-white border-2 border-dashed border-blue-200 rounded-3xl p-5 sm:p-6 md:p-8 flex flex-col items-center text-center hover:shadow-xl hover:border-[#1e3a8a]/30 hover:-translate-y-1 transition-all duration-500 group cursor-pointer h-full"
                >
