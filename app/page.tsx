              ...
              >
                <div className="absolute inset-0 w-full h-full" style={{ transform: `translateY(${scrollY * 0.4}px)` }}>
                  <Image
                    ...
                    fill
                    priority={idx === 0} 
                    className={cn("object-cover transition-transform duration-[10000ms] ease-out [object-position:75%_center] sm:[object-position:center_center]", currentSlideIndex === idx ? "scale-105" : "scale-100")}
                  />
                </div>
        ...
        <section className="relative bg-gradient-to-b from-[#0f2557] to-[#1e3a8a] overflow-hidden">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
              {[
                { value: stats.closed_needs, label: 'Нужд закрыто', icon: <HeartHandshake size={28} className="text-[#ffca63]" /> },
                { value: stats.people_helped, label: 'Получили помощь', icon: <Users size={28} className="text-[#ffca63]" /> },
                { value: stats.institutions_count, label: 'Учреждений в реестре', icon: <ShieldCheck size={28} className="text-[#ffca63]" /> },
              ].map((stat, idx) => (
                <div
                  key={idx}
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/60 font-semibold text-sm sm:text-base uppercase tracking-wider">{stat.label}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="container mx-auto max-w-[1440px] px-5 sm:px-6 md:px-12 xl:px-28 mb-10 sm:mb-14 md:mb-16">
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-[#1e3a8a] font-bold text-sm uppercase tracking-[0.15em]">Учреждения</span>
                </div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-black text-gray-900 leading-[1.1] mb-4 sm:mb-6">
                  Кому мы{' '}
                  <span className="relative inline-block">
                    <span className="relative z-10 text-[#1e3a8a]">помогаем</span>
                ...
                <p className="text-gray-500 text-base sm:text-lg md:text-xl leading-relaxed max-w-2xl">
                  Каждое учреждение в реестре проверено. Вы видите настоящие нужды и можете помочь адресно — без посредников и бюрократии.
                </p>
              </div>
            </div>
                ...
                <HorizontalScroller>
                  ...
                  >
                    <div className="w-14 h-14 rounded-2xl bg-[#1e3a8a]/10 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:bg-[#1e3a8a] transition-all duration-500">
                      <ArrowRight size={22} className="text-[#1e3a8a] group-hover:text-white transition-colors" />
                    </div>
                    <span className="text-[#1e3a8a] font-black text-sm tracking-wide">Смотреть все</span>
                    <span className="text-gray-400 text-xs mt-1 font-medium">{institutions.length}+ учреждений</span>
                  </Link>
                </HorizontalScroller>
              ) : (
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div className="relative">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl shadow-black/40 border-2 border-white/10">
                    <div className="relative h-[400px] sm:h-[500px] lg:h-[520px]">
                      <Image src="/landing_events.webp" alt="Создать событие" fill className="object-cover" />
                    </div>
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-4 flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-white font-bold text-sm sm:text-base">Создайте событие</p>
                        <p className="text-white/60 text-xs sm:text-sm">Другие волонтёры присоединятся</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 text-center lg:text-left space-y-6 lg:space-y-8">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-black text-white leading-[1.08]">
                  ...
                  любой праздник в{' '}
                  <span className="text-[#ffca63]">добро</span>
                </h2>

                <p className="text-base sm:text-lg lg:text-xl text-white/70 leading-relaxed max-w-xl mx-auto lg:mx-0">
                  Любой мастер-класс, концерт или праздник может стать благотворительным. Создайте событие на платформе — волонтёры увидят его и присоединятся. Вместе мы можем больше.
                </p>

                <div className="pt-2 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Button asChild size="lg" className="bg-[#ffca63] text-[#1e3a8a] hover:bg-white font-black h-14 px-10 rounded-full hover:scale-[1.03] transition-all group text-base sm:text-lg shadow-xl shadow-[#ffca63]/20">
                    <Link href="/events" className="flex items-center justify-center gap-3">
                      Календарь событий
                      <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                    </Link>
                  </Button>
                  <Button asChild variant="outline" size="lg" className="border-2 border-white/20 text-white hover:bg-white/10 font-bold h-14 px-10 rounded-full transition-all text-base sm:text-lg backdrop-blur-sm">
          ...
          >
            ...
            <div className="text-center mb-14 md:mb-20">
              <div className="flex items-center justify-center gap-3 mb-5">
                <div className="w-12 h-[3px] bg-[#ffca63] rounded-full"></div>
                <span className="text-[#1e3a8a] font-bold text-sm uppercase tracking-[0.15em]">Процесс</span>
                <div className="w-12 h-[3px] bg-[#ffca63] rounded-full"></div>
              </div>
              ...
              <p className="text-gray-500 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
                Простой и прозрачный процесс от выбора учреждения до доставки помощи
              </p>
            </div>
                  ...
                  >
                    <div className="relative bg-gradient-to-b from-[#f8fafc] to-white rounded-[2rem] p-6 sm:p-8 border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-500 group h-full">
                      ...
                      <div className="w-11 h-11 mb-5 bg-gradient-to-br from-[#1e3a8a] to-[#2d4fa5] rounded-xl shadow-md shadow-[#1e3a8a]/25 flex items-center justify-center">
                        <span className="text-[#ffca63] font-black text-lg">{step.id}</span>
                      </div>
                      ...
                      <h3 className="text-xl font-black text-gray-900 mb-3 text-center group-hover:text-[#1e3a8a] transition-colors">{step.title}</h3>
              ...
              {HOW_IT_WORKS.map((step, idx) => (
                <div 
                  ...
                  className={`relative group transition-all duration-700 ${
                    howItWorksReveal.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                  }`}
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-b from-[#f8fafc] to-white rounded-[2rem] p-8 lg:p-10 border border-gray-100/80 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 text-center overflow-hidden h-full">
                    ...
                    <div className="w-14 h-14 mx-auto mb-7 bg-gradient-to-br from-[#1e3a8a] to-[#2d4fa5] rounded-2xl shadow-lg shadow-[#1e3a8a]/25 flex items-center justify-center relative z-10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                      <span className="text-[#ffca63] font-black text-2xl">{step.id}</span>
                    </div>
                    ...
                    <h3 className="text-xl lg:text-2xl font-black text-gray-900 mb-3 group-hover:text-[#1e3a8a] transition-colors relative z-10">{step.title}</h3>
                    <p className="text-gray-500 text-sm lg:text-base leading-relaxed max-w-xs mx-auto relative z-10">{step.desc}</p>
                  </div>
                </div>
              ))}
            </div>
