...
const HERO_SLIDES = [
  ...
  },
  {
    ...
    subtitle: 'Каждое учреждение в реестре проверено. Вы видите реальные нужды и можете помочь тем, кто в этом нуждается.',
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
              ...
              <div className="flex-1 space-y-5 sm:space-y-6 lg:space-y-8 text-center lg:text-left z-10 mt-6 sm:mt-8 lg:mt-0 order-first lg:order-last">
                ...
                <p className="text-sm sm:text-base lg:text-xl text-white/80 leading-relaxed max-w-xl mx-auto lg:mx-0">
                  Любой праздник или мастер-класс можно сделать благотворительным. 
                  </p>
                  <p> Создайте событие на платформе — другие волонтеры присоединятся. 
                </p>
                  <p>Вместе мы можем больше!
                </p>
