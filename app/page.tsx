          ...
          <div className="container mx-auto max-w-[1440px] px-6 md:px-12 xl:px-28 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {DIRECTIONS.map((dir, idx) => (
                <div
                  key={idx}
                  className="group relative bg-white rounded-2xl p-10 hover:shadow-2xl transition-all duration-300 cursor-pointer border border-gray-100 hover:border-[#1e3a8a]/30 overflow-hidden transform hover:scale-105"
                >
                  ...
                  <div className="relative z-10">
                    <div className="w-20 h-20 bg-[#1e3a8a] rounded-3xl flex items-center justify-center text-white mb-8 shadow-lg shadow-[#1e3a8a]/30">
                      {dir.icon}
                    </div>
