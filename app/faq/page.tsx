...
const FAQ_ITEMS = [
  {
    ...
    items: [
      { q: 'Как работает платформа Пайванд?', a: 'Мы напрямую соединяем доноров (волонтеров) с государственными учреждениями. Учреждения публикуют списки нужд, а вы выбираете, что именно хотите купить и привезти. Мы не собираем деньги на свои счета — помощь передается из рук в руки.' },
      ...
      <div className="min-h-screen bg-[#f8fafc] pb-20 font-sans">
        ...
        <div className="container mx-auto max-w-4xl px-6 py-16 relative z-20">
           ...
           <div className="text-center mt-12">
              ...
              <a href="mailto:support@payvand.tj" className="text-[#1e3a8a] font-black hover:underline text-lg">
