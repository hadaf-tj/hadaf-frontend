...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    items: [
      { q: 'Нужно ли регистрироваться, чтобы помочь?', a: 'Вы можете просматривать список нужд без регистрации. Но чтобы забронировать нужду (нажать "Я привезу"), регистрация необходима, чтобы избежать дублирования помощи.' },
