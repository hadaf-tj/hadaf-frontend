...
export default function VolunteersPage() {
  ...
  const steps = [
    ...
    { icon: Search, title: t("step2Title"), text: t("step2Text") },
    { icon: Gift, title: t("step3Title"), text: t("step3Text") },
  ];
  return (
    <MainLayout>
      <div className="min-h-screen bg-[#f8fafc] font-sans pb-20">
        ...
        <div className="bg-[#1e3a8a] pt-24 pb-24 rounded-b-[3rem] text-center relative overflow-hidden">
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              <Link href="/register">{t("becomeVolunteer")}</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl mt-20 text-center">
          ...
          >
            <Link href="/faq">
              {t("goToFaq")} <ArrowRight size={18} className="ml-2" />
            </Link>
          </Button>
        </div>
      </div>
