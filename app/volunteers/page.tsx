    ...
    <MainLayout>
      <div className="min-h-screen bg-[#f8fafc] font-sans pb-20">
        ...
        <div className="bg-[#1e3a8a] pt-24 pb-24 rounded-b-[3rem] text-center relative overflow-hidden">
          <div className="container mx-auto px-6 relative z-10">
            ...
            <p className="text-white/80 text-xl max-w-2xl mx-auto mb-8">
              Волонтеры — это сердце нашего проекта. Узнайте, как просто начать
              помогать.
            </p>
            <Button
              asChild
              className="bg-[#ffca63] text-[#1e3a8a] hover:bg-[#ffd685] font-black text-lg h-14 px-8 rounded-2xl border-0 shadow-lg"
            >
            ...
            {[
              {
                icon: UserPlus,
                title: "1. Регистрация",
                text: "Создайте аккаунт волонтера. Это займет всего 2 минуты.",
              },
              {
                icon: Search,
                title: "2. Выбор нужды",
                text: "Найдите на карте или в списке то, что вы можете привезти.",
              },
              {
                icon: Gift,
                title: "3. Поездка",
                text: "Забронируйте нужду и отвезите помощь лично в руки.",
              },
            ].map((step, i) => (
              <div
                key={i}
        ...
        <div className="container mx-auto max-w-4xl mt-20 text-center">
          <h2 className="text-3xl font-black text-[#1e3a8a] mb-6">
            Остались вопросы?
          </h2>
          ...
          <Button
            asChild
            variant="outline"
            className="h-12 border-2 px-8 rounded-xl font-bold"
          >
            <Link href="/faq">
              Перейти в FAQ <ArrowRight size={18} className="ml-2" />
            </Link>
          </Button>
        </div>
      </div>
