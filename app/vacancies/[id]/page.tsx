...
import { Briefcase, MapPin, Clock, ArrowLeft, ArrowRight, Loader2 } from 'lucide-react';
          ...
          <div className="container mx-auto max-w-[1440px] px-5 sm:px-6 md:px-12 xl:px-28">
            {loading ? (
              ...
              <div className="text-center py-20">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Вакансия не найдена</h3>
                <button onClick={() => router.push('/vacancies')} className="text-[#1e3a8a] font-bold hover:underline mt-4">
                ...
                <div className="bg-white rounded-[2rem] p-8 sm:p-12 border border-gray-100 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10 bg-[#f8fafc] p-6 rounded-2xl">
                    <div className="flex items-center gap-3 text-gray-700 font-bold">
                      <MapPin size={20} className="text-[#229ED9] flex-shrink-0"/> Удалённо
                    </div>
                    <div className="flex items-center gap-3 text-gray-700 font-bold">
                      <Clock size={20} className="text-[#229ED9] flex-shrink-0"/> {vacancy.workload}
                    </div>
                    <div className="flex items-center gap-3 text-gray-700 font-bold">
                      <Briefcase size={20} className="text-[#229ED9] flex-shrink-0"/> {vacancy.experience}
                    </div>
                  </div>

                  {/* Description */}
                  <div className="prose prose-lg max-w-none">
                    <h3 className="text-xl font-black text-gray-900 mb-4">Описание</h3>
